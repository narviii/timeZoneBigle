const
  ...
  LocalSession = require('telegraf-session-local') // require('telegraf-session-local')

const bot = new Telegraf('820723993:AAHTtNf2QpeKTv_wMAQTffydcsZHXBkTlRo') // Your Bot token here
